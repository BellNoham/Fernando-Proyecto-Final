...
precio1= input("precio del articulo:")
precio2 = input("precio del articulo:")
precio3 = input("precio del articulo:")
precio4 = input("precio del articulo:")
precio5 = input("precio del articulo:")
